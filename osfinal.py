...
#plotting the graph function
        ...
        plot_button_quant = Button(master = window_quant, command = plot_quant, width = 32, text = "Quantum time")
...
f.pack()
f.pack_forget()
w1 = Label(root, text="\n    Scheduling Algorithm Simulator \n   \t", font=('Helveltika bold', 15))
w1.pack()
rr1 = Button(root, text="Round Robin Scheduling", width=32, command=rr1)
rr1.pack(padx=10)
l5 = Label(root, text='')
l5.pack()
